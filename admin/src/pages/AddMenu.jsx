    ...
    <div>
      <form onSubmit={OnSubmitHandler} className='flex flex-col items-start gap-1'>
        ...
        <div className='w-full'>
          ...
          <input value={description} onChange={(e) => setDescription(e.target.value)} className='w-full max-w-[500px] p-4 border border-gray-300 rounded' type="text" placeholder="Enter description" required/>
        </div>
