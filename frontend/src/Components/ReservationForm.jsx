...
<h1 className='text-3xl font-bold mb-4'>Dine With Us- <span className='text-amber-500'>Reserve Now</span></h1>
    <div className='grid md:grid-cols-2 gap-4'>
      <div className='grid gap-1.5'>
        <label htmlFor="" className='fonts-bold'>Full Name</label>
      ...
      <div className='grid gap-1.5'>
        <label htmlFor="" className='fonts-bold'>Email</label>
      ...
      <div className='grid gap-1.5'>
        <label htmlFor="" className='fonts-bold'>Phone Number</label>
      ...
      <div className='grid gap-1.5'>
        <label htmlFor="" className='fonts-bold'>Reservation Date</label>
        <input type="date" name='date' value={formData.date} onChange={handleChange} placeholder='Date' required className='w-full p-3 mb-3 border rounded-lg focus:ring focus:ring-blue-300'/>
      </div>
      <div className='grid gap-1.5'>
        <label htmlFor="" className='fonts-bold'>Reservation Time</label>
      ...
      <div className='grid gap-1.5'>
        ...
        <select name='guests' value={formData.guests} onChange={handleChange} required className='w-full p-3 mb-3 border rounded-lg focus:ring focus:ring-blue-300'>
          {[...Array(10).keys().map((i) => (
           ...
           <button type="submit" className='w-full mt-4 bg-amber-600 text-white p-3 rounded-lg hover:bg-amber-500 transition duration-300'>Book Now</button>
      </form>

      <div className='bg-black text-gray-300 p-8 rounded-lg shadow-md space-y-10'>
        <div>
          <h3 className='text-lg font-bold'>Address</h3>
          <p>4347, xyz, Saas-Bop Road, Katraj, Pune , Maharashtra</p>
        </div>
        <div>
          <h3 className='text-lg font-bold'>Open Time</h3>
          <p>Mon - Fri: 11:00 AM - 10:00 PM</p>
          <p>Sat - Sun: 09:00 PM - 11:00 PM</p>
        </div>
        <div>
