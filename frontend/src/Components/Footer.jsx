  ...
  return (
    <div className='flex flex-col gap-12 px-16 py-16 bg-white'>
      ...
      <div className='flex items-center justify-center max-w-xl mx-auto w-full'>
        <input type="email" placeholder='Enter your email' className='flex-grow px-4 py-3 border-2 border-r-0 border-amber-500 rounded-l-full outline-none text-sm'/>
        <button className='bg-amber-500 text-white px-6 py-3 rounded-r-full font-bold'>Join Now</button>
      </div>
      </div>
      <div className='flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-6'>
        <div>
          <h2 className='text-2xl font-bold text-gray-800'>Imperial Bites</h2>
        ...
        <div>
          <ul className='flex gap-6 justify-center text-gray-700 text-base'>
      ...
      <p className='text-center text-sm text-gray-500 mt-4'>@ 2026 Imperial Bites. All rights reserved.</p>
    </div>
  )
}
